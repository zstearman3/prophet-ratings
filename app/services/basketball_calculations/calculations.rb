module BasketballCalculations
  module Calculations
    def calculated_two_pt_percentage
      (two_pt_made.to_f / two_pt_attempted.to_f).round(5)
    end

    def calculated_three_pt_percentage
      (three_pt_made.to_f / three_pt_attempted.to_f).round(5)
    end

    def calculated_free_throws_percentage
      (free_throws_made.to_f / free_throws_attempted.to_f).round(5)
    end
    ...
    # class << self
    #   calculate_shooting_percentage(attempts, makes)
    #     (makes.to_f / attempts.to_f).round(5)
    #   end
    # end
  end
end
