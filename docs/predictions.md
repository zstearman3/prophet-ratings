...
This is a conservative v1 choice. It prevents the model from confidently applying home-court advantage to games where Sports Reference did not provide trustworthy location data. The unresolved follow-up is to improve coverage with manual overrides and, if needed, a small isolated source for schedule venue data.
